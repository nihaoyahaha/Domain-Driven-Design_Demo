...
public class IdentityRepository : IIdentityRepository
{
	...
	public Task<User?> FindByPhoneNumberAsync(string phoneNum) => userManager.Users.FirstOrDefaultAsync(u => u.PhoneNumber == phoneNum);
	public Task<User?> FindByIdAsync(Guid userId) => userManager.FindByIdAsync(userId.ToString());
	public Task<User?> FindByNameAsync(string userName) => userManager.FindByNameAsync(userName);
	public Task<IdentityResult> CreateAsync(User user, string password) => this.userManager.CreateAsync(user, password);
	public Task<IdentityResult> AccessFailedAsync(User user) => userManager.AccessFailedAsync(user);
	...
	public Task<string> GenerateChangePhoneNumberTokenAsync(User user, string phoneNumber) => this.userManager.GenerateChangePhoneNumberTokenAsync(user, phoneNumber);
